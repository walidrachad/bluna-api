...
import com.vaibhav.sec.model.UploadFileResponse;
...
public class FileController {
    ...
    public ResponseEntity<Resource> downloadFile(@PathVariable String fileName, HttpServletRequest request) {
        CacheControl cacheControl = CacheControl.maxAge(86400, TimeUnit.SECONDS);
    ...
    public ResponseEntity<?> sendMessage(@RequestPart( "file") MultipartFile file)  {
